/*
  ...
  - The values [Published,Draft] on the enum `ProjectStatus` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterTable
ALTER TABLE "projects" ALTER COLUMN "status" SET DEFAULT E'DRAFT';
